...
export default function EraserSettings({ color, setColor, strokeWidth, setStrokeWidth }: { color: string, setColor: (color: string) => void, strokeWidth: number, setStrokeWidth: (width: number) => void }) {
    return (
